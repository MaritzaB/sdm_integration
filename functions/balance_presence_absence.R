...
sample_absences <- function(absences_data, num_presences, sample_ratio = 1.2) {
...
balance_data_for_one_month_year <- function(presences_data, absences_data, year, month, sample_ratio = 1.2) {
